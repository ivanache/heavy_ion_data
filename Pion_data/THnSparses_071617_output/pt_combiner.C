...
void pt_combiner() {
    ...
    char filenames[num_of_samples][50] = {"data/Pion0cutsSparsesOutput.root", "data/Pion1cutsSparsesOutput.root", "data/Pion2cutsSparsesOutput.root", "data/Pion3cutsSparsesOutput.root", "data/Pion4cutsSparsesOutput.root"};
    //Grab the files
    ...
    int colors[num_of_samples] = {kRed, kBlue, kGreen, kYellow, kCyan};
    ...
    myBoxText(0.20, 0.70, 0.05, colClear, colors[4], "Additional cut: lambda02");
    // Graph residuals
    canvas->cd();
    pad[1]->Draw();
    pad[1]->cd();
    ...
    myBoxText(0.50, 0.23, 0.05, colClear, colors[4], "Additional cut: lambda02");
    //Save
    ...
    myBoxText(0.20, 0.65, 0.05, colClear, colors[4], "Additional cut: lambda02");
    //Save
    ...
    integral_mom_cuts[0]->GetYaxis()->SetRangeUser(0.0, 50000.);
    ...
    myBoxText(0.60, 0.78, 0.05, colClear, colors[2], "Cuts: dR and asymmetry");
    myBoxText(0.60, 0.73, 0.05, colClear, colors[3], "Additional cut: angle");
    myBoxText(0.60, 0.68, 0.05, colClear, colors[4], "Additional cut: lambda02");
    //Save
