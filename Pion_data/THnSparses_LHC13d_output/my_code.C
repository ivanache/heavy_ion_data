/**
 my_code is a data-processing macro meant for processing THnSparses root files, specifically the h_Pion one in THnSparses_LHC13d.root
...
void my_code() {
    ...
    //Open the files
    TFile* fIn = new TFile("THnSparses_LHC13d.root","READ"); //get file
    string rootfilename;
    rootfilename = Form("PionDataOutput.root");
