...
int main(int argc, char *argv[])
{
	...
	num_purity_NN.Write("NumPurity_NN");
        num_purity_NN.Sumw2();
        histogram1.Sumw2();
	num_purity_NN.Divide(&histogram1);
	num_purity_NN.SetTitle("; cluster p_{T} [GeV] with NN >0.85; Purity");
	num_purity_NN.Write("Purity_NN");
	num_purity_Lambda.Write("NumPurity_Lambda");
        num_purity_Lambda.Sumw2();
        histogram2.Sumw2();
	...
	histogram2.Divide(&num_purity_Lambda);
        ...
        histogram2.Write("ClosureTest_Lambda");          
