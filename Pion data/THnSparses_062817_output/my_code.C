/**
 my_code is a data-processing macro meant for processing THnSparses root files, specifically the h_Pion one in THnSparses_062817.root
...
void my_code(int NumOfCuts) {
    ...
    //Open the files
    TFile* fIn = new TFile("THnSparses_062817.root","READ"); //get file
