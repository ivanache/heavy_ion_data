...
const string directory_name = "Photon_data/";
...
void photon_analyzer() {
    ...
    TFile* pionIn = new TFile("Pion4CutsSparsesOutput.root", "READ");
    TH1D* piondata = 0;
    ...
    hEnergy->SetTitle("Leading Photon Energy vs eigenvalue; eigenvalue; Leading photon energy (GeV)");
    hEnergy->Draw("COLZ");
    myText(.35,.9, kBlack, "Leading Photon Energy vs eigenvalue");
    ...
    hEnergy->SetTitle("Trailing Photon Energy vs eigenvalue; eigenvalue; Trailing photon energy (GeV)");
    hEnergy->Draw("COLZ");
    myText(.35,.9, kBlack, "Trailing Photon Energy vs eigenvalue");
