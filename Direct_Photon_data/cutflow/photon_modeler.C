/**
   This macro is responsible for graphing a spectrum of the pion data from THnSparses_072417.root
...
void photon_modeler() {
    ...
    TFile* fOut = new TFile("gamma_cutflow.root", "RECREATE");
    ...
    // Graph the pT-photon data, calculate the total number of photons in the set, and store this data in a string intended for use in the .tex files with a table
