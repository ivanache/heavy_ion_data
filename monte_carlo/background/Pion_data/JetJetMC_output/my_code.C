/**
 my_code is a data-processing macro meant for processing THnSparses root files, specifically the h_Pion one in THnSparses_JetJetMC.root
...
void my_code() {
    ...
    //Open the files
    TFile* fIn = new TFile("THnSparses_JetJetMC.root","READ"); //get file
    string rootfilename;
    rootfilename = Form("MCPionDataOutput.root");
    ...
    for (int i = 0; i < num_of_intervals; i++) {
        ...
        asymmetry_curve->GetYaxis()->SetTitleOffset(1.4);
