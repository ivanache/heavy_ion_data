...
// Tue Dec 19 12:53:53 2017 by ROOT version 6.10/08
// from TTree _tree_event/
// found on file: 13d_small.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          ncluster;
   Float_t         cluster_e[213];   //[ncluster]
   Float_t         cluster_pt[213];   //[ncluster]
   Float_t         cluster_eta[213];   //[ncluster]
   Float_t         cluster_phi[213];   //[ncluster]
   Float_t         cluster_lambda_square[213][2];   //[ncluster]
   Float_t         cluster_tof[213];   //[ncluster]
   Int_t           cluster_ncell[213];   //[ncluster]
   UShort_t        cluster_cell_id_max[213];   //[ncluster]
   Float_t         cluster_e_max[213];   //[ncluster]
   Float_t         cluster_e_cross[213];   //[ncluster]
   UInt_t          cluster_nmc_truth[213];   //[ncluster]
   UShort_t        cluster_mc_truth_index[213][32];   //[ncluster]
   Float_t         cluster_iso_tpc_01[213];   //[ncluster]
   Float_t         cluster_iso_tpc_02[213];   //[ncluster]
   Float_t         cluster_iso_tpc_03[213];   //[ncluster]
   Float_t         cluster_iso_tpc_04[213];   //[ncluster]
   Float_t         cluster_iso_its_01[213];   //[ncluster]
   Float_t         cluster_iso_its_02[213];   //[ncluster]
   Float_t         cluster_iso_its_03[213];   //[ncluster]
   Float_t         cluster_iso_its_04[213];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_02[213];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_05[213];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_10[213];   //[ncluster]
   Float_t         cluster_frixione_its_04_02[213];   //[ncluster]
   Float_t         cluster_frixione_its_04_05[213];   //[ncluster]
   Float_t         cluster_frixione_its_04_10[213];   //[ncluster]
   Float_t         cluster_iso_01_truth[213];   //[ncluster]
   Float_t         cluster_iso_02_truth[213];   //[ncluster]
   Float_t         cluster_iso_03_truth[213];   //[ncluster]
   Float_t         cluster_iso_04_truth[213];   //[ncluster]
   Float_t         cluster_frixione_04_02_truth[213];   //[ncluster]
   Float_t         cluster_frixione_04_05_truth[213];   //[ncluster]
   Float_t         cluster_frixione_04_10_truth[213];   //[ncluster]
   Float_t         cluster_s_nphoton[213][4];   //[ncluster]
   Float_t         cluster_s_ncharged_hadron[213][4];   //[ncluster]
   Float_t         cell_e[17664];
   Float_t         cell_tof[17664];
   UShort_t        cell_mc_truth_index[17664];
   UInt_t          ntrack;
   Float_t         track_e[936];   //[ntrack]
   Float_t         track_pt[936];   //[ntrack]
   Float_t         track_eta[936];   //[ntrack]
   Float_t         track_phi[936];   //[ntrack]
   Char_t          track_charge[936];   //[ntrack]
   UChar_t         track_quality[936];   //[ntrack]
   Float_t         track_tpc_dedx[936];   //[ntrack]
   Float_t         track_tpc_length_active_zone[936];   //[ntrack]
   UChar_t         track_tpc_xrow[936];   //[ntrack]
   UChar_t         track_tpc_ncluster[936];   //[ntrack]
   UChar_t         track_tpc_ncluster_dedx[936];   //[ntrack]
   UChar_t         track_tpc_ncluster_findable[936];   //[ntrack]
   UChar_t         track_its_ncluster[936];   //[ntrack]
   Float_t         track_its_chi_square[936];   //[ntrack]
   Float_t         track_dca_xy[936];   //[ntrack]
   Float_t         track_dca_z[936];   //[ntrack]
   UShort_t        track_mc_truth_index[936];   //[ntrack]
   Float_t         track_voronoi_area[936];   //[ntrack]
   UInt_t          nmc_truth;
   ...
   Float_t         cluster_NN1[213];   //[ncluster]
   Float_t         cluster_NN2[213];   //[ncluster]
   Float_t         cluster_Lambda[213];   //[ncluster]
   Float_t         cluster_isHardPhoton[213];   //[ncluster]
   Float_t         cluster_minMass[213];   //[ncluster]
   Int_t           cluster_pi0tagged[213];   //[ncluster]
