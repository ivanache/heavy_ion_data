...
// Tue Dec 19 13:47:32 2017 by ROOT version 6.10/08
// from TTree _tree_event/
// found on file: 17g6a3_pthat2_small.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          ncluster;
   Float_t         cluster_e[19];   //[ncluster]
   Float_t         cluster_pt[19];   //[ncluster]
   Float_t         cluster_eta[19];   //[ncluster]
   Float_t         cluster_phi[19];   //[ncluster]
   Float_t         cluster_lambda_square[19][2];   //[ncluster]
   Float_t         cluster_tof[19];   //[ncluster]
   Int_t           cluster_ncell[19];   //[ncluster]
   UShort_t        cluster_cell_id_max[19];   //[ncluster]
   Float_t         cluster_e_max[19];   //[ncluster]
   Float_t         cluster_e_cross[19];   //[ncluster]
   UChar_t         cluster_nlocal_maxima[19];   //[ncluster]
   UInt_t          cluster_nmc_truth[19];   //[ncluster]
   UShort_t        cluster_mc_truth_index[19][32];   //[ncluster]
   Float_t         cluster_iso_tpc_01[19];   //[ncluster]
   Float_t         cluster_iso_tpc_01_ue[19];   //[ncluster]
   Float_t         cluster_iso_tpc_02[19];   //[ncluster]
   Float_t         cluster_iso_tpc_02_ue[19];   //[ncluster]
   Float_t         cluster_iso_tpc_03[19];   //[ncluster]
   Float_t         cluster_iso_tpc_03_ue[19];   //[ncluster]
   Float_t         cluster_iso_tpc_04[19];   //[ncluster]
   Float_t         cluster_iso_tpc_04_ue[19];   //[ncluster]
   Float_t         cluster_iso_its_01[19];   //[ncluster]
   Float_t         cluster_iso_its_01_ue[19];   //[ncluster]
   Float_t         cluster_iso_its_02[19];   //[ncluster]
   Float_t         cluster_iso_its_02_ue[19];   //[ncluster]
   Float_t         cluster_iso_its_03[19];   //[ncluster]
   Float_t         cluster_iso_its_03_ue[19];   //[ncluster]
   Float_t         cluster_iso_its_04[19];   //[ncluster]
   Float_t         cluster_iso_its_04_ue[19];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_02[19];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_05[19];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_10[19];   //[ncluster]
   Float_t         cluster_frixione_its_04_02[19];   //[ncluster]
   Float_t         cluster_frixione_its_04_05[19];   //[ncluster]
   Float_t         cluster_frixione_its_04_10[19];   //[ncluster]
   Float_t         cluster_iso_01_truth[19];   //[ncluster]
   Float_t         cluster_iso_02_truth[19];   //[ncluster]
   Float_t         cluster_iso_03_truth[19];   //[ncluster]
   Float_t         cluster_iso_04_truth[19];   //[ncluster]
   Float_t         cluster_frixione_04_02_truth[19];   //[ncluster]
   Float_t         cluster_frixione_04_05_truth[19];   //[ncluster]
   Float_t         cluster_frixione_04_10_truth[19];   //[ncluster]
   Float_t         cluster_s_nphoton[19][4];   //[ncluster]
   Float_t         cluster_s_ncharged_hadron[19][4];   //[ncluster]
   Float_t         cell_e[17664];
   Float_t         cell_tof[17664];
   UShort_t        cell_cluster_index[17664];
   UShort_t        cell_mc_truth_index[17664];
   UInt_t          ntrack;
   Float_t         track_e[396];   //[ntrack]
   Float_t         track_pt[396];   //[ntrack]
   Float_t         track_eta[396];   //[ntrack]
   Float_t         track_phi[396];   //[ntrack]
   Float_t         track_eta_emcal[396];   //[ntrack]
   Float_t         track_phi_emcal[396];   //[ntrack]
   Char_t          track_charge[396];   //[ntrack]
   UChar_t         track_quality[396];   //[ntrack]
   Float_t         track_tpc_dedx[396];   //[ntrack]
   Float_t         track_tpc_length_active_zone[396];   //[ntrack]
   UChar_t         track_tpc_xrow[396];   //[ntrack]
   UChar_t         track_tpc_ncluster[396];   //[ntrack]
   UChar_t         track_tpc_ncluster_dedx[396];   //[ntrack]
   UChar_t         track_tpc_ncluster_findable[396];   //[ntrack]
   UChar_t         track_its_ncluster[396];   //[ntrack]
   Float_t         track_its_chi_square[396];   //[ntrack]
   Float_t         track_dca_xy[396];   //[ntrack]
   Float_t         track_dca_z[396];   //[ntrack]
   UShort_t        track_mc_truth_index[396];   //[ntrack]
   Float_t         track_voronoi_area[396];   //[ntrack]
   UInt_t          nmc_truth;
   Float_t         mc_truth_e[4312];   //[nmc_truth]
   Float_t         mc_truth_pt[4312];   //[nmc_truth]
   Float_t         mc_truth_eta[4312];   //[nmc_truth]
   Float_t         mc_truth_phi[4312];   //[nmc_truth]
   Char_t          mc_truth_charge[4312];   //[nmc_truth]
   Short_t         mc_truth_pdg_code[4312];   //[nmc_truth]
   UChar_t         mc_truth_status[4312];   //[nmc_truth]
   UChar_t         mc_truth_generator_index[4312];   //[nmc_truth]
   Short_t         mc_truth_first_parent_pdg_code[4312];   //[nmc_truth]
   Float_t         mc_truth_first_parent_e[4312];   //[nmc_truth]
   Float_t         mc_truth_first_parent_pt[4312];   //[nmc_truth]
   Float_t         mc_truth_first_parent_eta[4312];   //[nmc_truth]
   Float_t         mc_truth_first_parent_phi[4312];   //[nmc_truth]
   UShort_t        mc_truth_sibling_index[4312];   //[nmc_truth]
   Float_t         cluster_NN1[19];   //[ncluster]
   Float_t         cluster_NN2[19];   //[ncluster]
   Float_t         cluster_Lambda[19];   //[ncluster]
   Float_t         cluster_isHardPhoton[19];   //[ncluster]
   Float_t         cluster_minMass[19];   //[ncluster]
   Int_t           cluster_pi0tagged[19];   //[ncluster]
   Float_t         cluster_b5x5[19];   //[ncluster]
   Float_t         cluster_b5x5_lin[19];   //[ncluster]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("17g6a3_pthat2_small.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("17g6a3_pthat2_small.root");
      }
